...
void GPIO_Init(void)
{
    ...
    GPIOB_AFRL |= (1 << 20); // Select the PA5 pin in alternate function mode
...
void TIM2_Init()   // to gernarate pwm signal at PA5
{
    ...
    TIM2_CCR1 = 500; // Pulse width for PWM (ON for 0.5 ms)
}
